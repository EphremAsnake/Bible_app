...
class DatabaseService {
  ...
  Future<List<Verses>> readVersesDatabase(String book, String from) async {
  ...
  Future<String> readVersesfromDB(
    ...
    // Query the database
    List<Map<String, dynamic>> rows = await database.rawQuery(book == "ENGNIV"
