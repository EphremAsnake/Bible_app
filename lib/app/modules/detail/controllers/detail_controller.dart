...
import 'package:american_bible/app/data/models/bible/book.dart';
import 'package:american_bible/app/data/models/bible/devotion.dart';
...
import 'package:american_bible/app/modules/detail/controllers/configs_http_attribs.dart';
...
class DetailController extends SuperController {
  ...
  setInitialSelectedBookTypeOptions() async {
    ...
    if (bookName != null) {
      ...
      allVerses.addAll(selectedBook == "English NIV"
          ? getterAndSetterController.groupedBookListAMHNIV()
          : getterAndSetterController.groupedBookList());
    }
    update();
  ...
  setSelectedBookTypeOptionss(String newValue) {
  ...
  changeBibleFromSearch(String bibleType) async {
    ...
    allVerses.assignAll(saveName.contains("NIV")
        ? getterAndSetterController.groupedBookListAMHNIV()
        : getterAndSetterController.groupedBookList());
