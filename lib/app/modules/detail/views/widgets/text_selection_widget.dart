...
import 'package:american_bible/app/data/models/bible/versesAMH.dart';
...
class _CompareDialogState extends State<CompareDialog> {
  ...
  List<String> americanStandardVerseText = [];
  ...
  Future<void> initclass() async {
    ...
    for (var verse in widget.selectedVerses) {
      ...
      americanStandardVerseText.add(await DatabaseService().readVersesfromDB(
                          ...
                          if (detailController.selectedBook !=
                            ...
                            Column(children: [
                              Container(
                                ...
                                padding: const EdgeInsets.all(8.0),
                                child: Text(
                                  '${Keys.defaultbibleName} - $chapterNAME ${lVerse.chapter!}:${lVerse.verseNumber!}',
                                  style: const TextStyle(color: Colors.white),
                                ),
                              ),
                              const SizedBox(height: 8.0),
                              ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    var lVerse = widget.selectedVerses[index];
                                    String verset =
                                        americanStandardVerseText[index];
                                    return Padding(
                                      padding: const EdgeInsets.symmetric(
                                          horizontal: 5.0),
                                      child: RichText(
                          ...
                          if (detailController.selectedBook != 'English KJV')
                            Column(children: [
                              Container(
                                ...
                                padding: const EdgeInsets.all(8.0),
                                child: Text(
                                  'English KJV - $chapterNAME ${lVerse.chapter!}:${lVerse.verseNumber!}',
                                  style: const TextStyle(color: Colors.white),
                                ),
                              ),
                              const SizedBox(height: 8.0),
                          ...
                          if (detailController.selectedBook != 'English NIV')
                            Column(children: [
                              Container(
                                ...
                                padding: const EdgeInsets.all(8.0),
                                child: Text(
                                  'English NIV - $chapterNAME ${lVerse.chapter!}:${lVerse.verseNumber!}',
                                  style: const TextStyle(color: Colors.white),
                                ),
                              ),
                              const SizedBox(height: 8.0),
