...
final Map<String, String> ml = {
  ...
  'info': '信息',
  'changed_to_amh_1954': "圣经类型已更改为阿姆哈拉语1954年版",
  'changed_to_amh_new': "圣经类型已更改为阿姆哈拉语新译本",
  'changed_to_eng_niv': "圣经类型已更改为英文NIV",
  'changed_to_eng_kjv': "圣经类型已更改为英文KJV",
  'font_size': "字体大小",
  'share': '分享',
  'rate': '评分应用',
  'copy': '复制',
